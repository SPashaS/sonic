(() => {
  ...
  const E = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (r = b(e), n = 0; n < r.length; n += 1) if (r[n] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!n.support.smoothScroll)
            return (
              O({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, r) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              O({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  const V = {
    loopCreate: function () {
      ...
      for (let e = 0; e < o.length; e += 1)
        r.append(C(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
        r.prepend(C(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function R(e) {
    ...
    if (
      ...
      d.is(r.focusableElements) &&
        ...
        s.activeElement &&
          C(s.activeElement).is(r.focusableElements) &&
          s.activeElement !== d[0] &&
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: n } = t.navigation,
          a = s.target;
        if (t.params.navigation.hideOnClick && !C(a).is(n) && !C(a).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function pe(e) {
          ...
          a.each((e) => {
            ...
            t.loadImage(a[0], d || l, c, p, !1, () => {
              if (null != t && t && (!t || t.params) && !t.destroyed) {
                ...
                r("lazyImageReady", n[0], a[0]),
                  t.params.autoHeight && t.updateAutoHeight();
              }
            }),
              r("lazyImageLoad", n[0], a[0]);
          });
    }
    function l() {
      const { $wrapperEl: e, params: s, slides: i, activeIndex: r } = t,
      ...
      if (
        ...
        e.children(`.${s.slideVisibleClass}`).each((e) => {
          o(n ? C(e).attr("data-swiper-slide-index") : C(e).index());
        });
    ...
    function d() {
      ...
      p ? (l(), s.off("scroll", d, h)) : n || ((n = !0), s.on("scroll", d, h));
    }
    i("beforeInit", () => {
    ...
    !(function (e) {
      ...
      setTransition: (e) => {
        ...
        (s ? t.slides.find(s) : t.slides).transition(e),
          (function (e) {
            let { swiper: t, duration: s, transformEl: i, allSlides: r } = e;
            const { slides: n, activeIndex: a, $wrapperEl: o } = t;
            if (t.params.virtualTranslate && 0 !== s) {
              let e,
                s = !1;
              (e = r ? (i ? n.find(i) : n) : i ? n.eq(a).find(i) : n.eq(a)),
                e.transitionEnd(() => {
                  if (s) return;
                  if (!t || t.destroyed) return;
                  (s = !0), (t.animating = !1);
    ...
    fe(),
      document.querySelector(".projects__swiper") &&
        new de(".swiper", {
          ...
          loop: !0,
          lazy: !0,
          navigation: { nextEl: ".projects__next" },
          on: {},
        }),
      document.querySelector(".project-page__slider") &&
        window.innerWidth <= "833.98" &&
        new de(".swiper", {
          modules: [ce, pe],
          observer: !0,
          observeParents: !0,
          ...
          lazy: !0,
          navigation: {
            nextEl: ".project-page__navigation .project-page__btn_next",
            prevEl: ".project-page__navigation .project-page__btn_prev",
          },
          on: {},
        });
  });
